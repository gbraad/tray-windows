...
namespace CRCTray
{
    internal class CRCTray : ApplicationContext
    {
        ...
        public CRCTray()
        {
            ...
            TaskHandlers.StatusChanged += UpdateClusterStatusMenu;
        ...
        {
            TrayIcon.NotifyWarn(@"Deleting Cluster");
            ...
            if (deleteResult != null)
            {
                if (deleteResult.Success)
                    ...
                    TrayIcon.NotifyWarn(@"Could not delete the cluster. Please check detailed atatus");
            }            
        }
        ...
        async private void StopMenu_Click(object sender, EventArgs e)
        {
            ...
            if (stopResult != null)
            {
                if (stopResult.Success)
                    ...
                    TrayIcon.NotifyWarn(@"Cluster did not stop. Please check detailed status");
            }            
        }
        ...
        private void UpdateClusterStatusMenu(StatusResult statusResult)
        {
